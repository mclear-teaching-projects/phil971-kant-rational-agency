...
**** Chen
#+begin_quote
Will Hieronymi’s answerability face the problem of manipulation? 
#+end_quote

I think Hieronymi would say (though I don't know this to be the case...) that in
manipulation or coercion cases the agent wouldn't be able to appropriately annswer
the why question. For exmaple, the person wouldn't be leaving for the worldly reason
that the conference was boring, but for the reason that she had been manipulated or
coerced into having a particular belief---viz. that the conference was boring. 

#+begin_quote
I do not quite understand Hieronymi’s view that “fundamental responsibility actually required such a lack of discretion” (p.19), although she explains a lot. Does she think that discretion actually weaken responsibility?
#+end_quote

I don't think that she thinks discretion *weakens* responsibility (certainly not in
the case of intentional action). It is that she thinks it cannot explain
responsibility in certain cases (like in cases of believing). Why? This is not clear
to me. One issue may be that she think it would invoke a regress (e.g. the reference
to Galen Strawson in note 14.

#+begin_quote
Does answering a why-question require no reflection at all? 
#+end_quote

Fair question. Though I would think that answering a why question concerning things
like perceptual beliefs wouldn't need to involve reflection, at least as understood
by Hieronymi. 
**** Trevor
#+begin_quote
My question is, what is going in that portion of the paper that starts with, “Let us grant”.
#+end_quote

Good question!

#+begin_quote
Second question, how could the regress even getted started that he also mentions on page 186? I ask because it seems like premise (2) is false since the evidence for p itself may just be formed by an immediate perception coupled with heuristic that is employed unconsciously.
#+end_quote

Yes, but the idea is that the regress is working within a dialectic concerning
someone who endorses Taking. And Taking is a personal level phenomenon (so no
unconscious heuristics generated by modular cognitive machinery).
**** Eunhong
#+begin_quote
 I am wondering whether Hieronymi is begging the question or commits straw man fallacy to the arguments of the champion of reflection. If one says that self-reflection provides us with the control over ourselves required for responsibility, at first glance, it might seem obscure because self-knowledge or self-consciousness does not seem to have that power of control. However, according to Kant, there are two kinds of consciousness of self
#+end_quote

So I agree that the objection is potentially avoidable by Kant, who builds his
conception of (pure or intellectual) self-consciousness from a view about a causal
power that is in one's control. But this is not the way at least some of the
contemporary Kantian accounts see things (e.g. Frankfurt, McDowell, or Korsgaard). 

#+begin_quote
As Hieronymi said, if our agency with respect to our intentions lacks both discretion and awareness, how can we even think of the jurisdiction? The only thing that we can represent will be the dog’s behavior, not the agency itself. Then, how can we even get the concept of the jurisdiction of dog’s behavior? It seems for me that Hieronymi’s ‘Why?’ question and the answerability rather helps the champion of the reflection. Maybe, she should have said that you are not responsible for your dog’s misbehavior.  
#+end_quote

While aspects of Hieronymi's positive view are opaque to me, I take it that she
construes one's jurisdiction with respect to the dog to be that one has control over
the conditions of the dog's actions, e.g., by tying it up. As she puts it "you can
affect and control these things through your intentional actions; they are, in some
sense, yours; and so you are open to assessment on account of them" (p. 11). I have
jurisdictional responsibility with respect to my dog's actions because I can
intentionally act in a way that controls the dog's action (or the available set of
actions in which it can engage).

#+begin_quote
 this second question seems to be related to the causation problem indirectly. People use ‘Why?’ questions ambiguously in the following two ways. : The way we are talking about the causation and the way that we are talking about the explanation. As for me, if Hieronymi does not distinguish two ways of using ‘Why?’ question, it seems for me that you are answerable for your dog’s misbehavior rather using the jurisdiction concept.
#+end_quote

I'm not sure why pointing to the cause of something wouldn't be giving an explanation
of it.

As for the specific case of the dog acting because (1) I didn't tie him well and (2)
because he is bored, I take it that all agree that the dog is not responsible for its
acts. So the cause of the dog's biting the mailman is that the dog is bored, but the
responsibility for the dog doing this is borne by me, because I didn't tie him as I
should have. 
**** John
#+begin_quote
My question: Is Setiya looking for an account of analogy that borders on conflating actions and beliefs all together?
#+end_quote

Setiya thinks that there is an important difference between the sense in which we are
active in our doxastic states, and the sense in which we are active in intending. In
the former (he argues) we are active in no further sense that we form and revise
beliefs (or doxastic states generally) based on reasons. In the case of intending, we
are active in the more substantive sense that it (1) requires a robust form of
rational causation (and not mere conjunction of beliefs); (2) we can and often do act
on grounds that are not reasons (see pp. 192-3 for discussion of these two points). 

#+begin_quote
My question: But awareness is also not always luminous in my deliberate actions, right? 
#+end_quote

I don't think it is an issue of the "luminosity of awareness" (usually "luminosity"
is used with respect to mental states like belief and desire, such that one is aware
of them simply by having them). But I take it that Feldman's point is simply one that
Hieronymi would agree with. After all, she is rejecting reflection (as the
combination of awareness and discretion) as necessary for control/responsibility. 
**** Janelle
#+begin_quote
(1) Grammatically, I am confused about which verb tense is supposed to be tracking static and dynamic. I could not follow. 
(2) If it is the perfect verb tense, then this might be a problem as modern grammarians see it as a completion of an action, which seems dynamic to me.
(3) Is this view consistent with Bayesians? So, if I have a credence of 34 percent that Kant had X view, and I did research to raise my 34 percent to 87 percent, is this still static? Or would Setiya reject this understanding?
(4) With respect to the disjunct views about beliefs, if we can just do DI to our beliefs (particularly if we are trying to figure things out about a new topic), would this be a worry or count as active? Moreover, in the same way we added, we could do DE to get rid of a belief, though that might take a little work, so there may be an asymmetry between belief acquisition and getting rid of a belief. 
(5) All of this confusion for me rests on which understanding of “state” that Setiya is using. Is it the fragile glass kind of state or the kind of state one gets from acting in certain ways that then remain static after acquiring it. The reason I am asking is that we might be actively believing just because we are always acting or perceiving in different ways. 
#+end_quote

1. Dynamic acts are those that correspond to acts picked out by verbs that posses a
   progressive and perfective aspect ("the floor was shaking", "the floor shook").
   Static acts are those picked out by verbs/verb phrases that lack a perfective
   aspect (i.e. lack a "completion") such as "the fruit was/is red".
2. Dynamic acts admit of completion, and are picked out by verb/verb phrases that
   have a perfective (and possibly progressive) aspect
3. I think that Setiya construes credences as static. Consider, e.g., whether a
   credence can be completed. If it can't then it is static. 
4. I think we addressed this one in class. 
5. It might help to look at the SEP discussion of events and states.
   https://plato.stanford.edu/entries/events (see 2.1)
** Week 12
*** Reading Responses
**** Janelle
#+begin_quote
if there is a separation between happiness and morality, is reason present in both
domains?
#+end_quote

Happiness, in and of itself, need not be rationally (morally) constrained at all. But
Kant thinks that the happiness one aims at as part of the highest good /is/ morally
constrained. He says, of the happiness that is part of the highest good that it "is
something that, though always pleasant to the possessor of it, is not of itself
absolutely and in all respects good but always presupposes morally lawful conduct as
its condition" (CPrR 5:111).

#+begin_quote
Recognizing that one’s action is consistent with the moral law is a feeling moved by
pure practical reason, but the former is pathological, so in what way has reason
transformed the pathological?
#+end_quote

Good question! I'm not clear how the proponent of TR is going to handle all of the
places where Kant seems to present the "animal" or "pathological" as competing with
morality.

**** John
#+begin_quote
if the additive-transformative debate is essentially a disagreement about the
‘metaphysical’ relations between reason and other non-rational faculties, won’t the
Teleological Transformation view be dodging said question then by focusing on ends,
rather than internal relations?
#+end_quote

That is an interesting point. Though if on thinks that the end toward which a
capacity aims is part of the individuating conditions of the capacity, we seem to
have a straightforward case of a "metaphysical" relation between reason and the other
faculties. But Schafer seems to want to remain neutral as to the truth of the
essentialist version of TR (i.e. "Transformation of Essential Nature"). So is the
worry that if his version of TR doesn't entail a change in essential nature that it
doesn't deserve to be called "transformative"? I guess this depends on what one means
by "transformative" doesn't it? I take Schafer to be aiming at a version that gets
some of what the essentialist version wants but not all of it.

#+begin_quote
If Persuasion exists as inadequate case of Fürwahrhalten, it is possible then to say
that S can opt not to be governed by the principles of understanding, contrary to
what is claimed?
#+end_quote

In the case of Persuasion, one is supposed to think that one is acting according to
epistemic standards, only one has gone "off the rails" in one fashion or another. 

#+begin_quote
I thought the notion of “ideal cognition” is untenable as argued. I was wondering
where (what page?) did Sasha address this in the preceding discussions. I seem to
have missed it.
#+end_quote

I think the "ideal" here is just complete systematicity of knowledge, e.g.: "reason
helps us gain knowledge of nature...by projecting the idea of systematic unity as the
ideal goal toward which our cognition ought to strive...in its real or transcendental
use reason not only seeks out conditions that would allow us to connect particular
claims, it also seeks an ultimate condition or ground that would, hypothetically,
allow us to connect all particular claims, thus creating a single, coherent whole of
knowledge. This notion of an ultimate condition, containing within it the complete
...
nothing further remains to be explained" (80)

**** Eunhong
#+begin_quote
Is it possible for us to possess a faculty for sensibility without possessing higher intellectual faculties? 
#+end_quote

Well, it is clear that Kant thinks this is the case with non-rational animals. Since
human beings are supposed to be /rational/ animals, this is not possible.

#+begin_quote
My first question of Schafer’s moderate transformative view is whether Schafer's moderate view can really be regarded as the transformative view (As for me, it seems a little bit the additive view). 
#+end_quote

This is a good question! It all comes down to what one means by "transformation". If
that entails an essentialist difference then it is unclear whether Schafer's
"teleological transformation" is enough (unless a teleological difference entails a
difference in essence).

#+begin_quote
I think the basic necessary condition for the transformative view is that the possession of rational capacities changes the essence or nature of one’s other capacities.
#+end_quote

I take it that this is part of what is up for debate. 
**** Chen
#+begin_quote
It seems the positions of these rational capacities depend on how philosophers understand them. Are Schafer, Longuenesse and other philosophers discussing this problem of “unified system” based on the similar definitions of those critical terms or based on totally different understanding of those terms? 
#+end_quote

It is an interpretive problem as to how exactly the different capacities of the
intellectual faculty are individuated. It doesn't help that Kant seems to change his
mind about this over time. Schafer and Longuenesse (and others) agree that at least
understanding, judgment, and reason are all part of the intellect. They also agree
that the intellectual capacities (whatever they are) are all spontaneous rather than
receptive. 

#+begin_quote
Is a “unified system” a system in which all other capacities are from one fundamentally critical capacity or a system in which all other capacities are for one ultimately critical capacity? 
#+end_quote

This is part of the debate right now -- i.e. how to characterize the dependence of
faculties on one another, and of animal on rational faculties in particular. 

#+begin_quote
In “concepts of reason serve for comprehension, just as concepts of the understanding serve for understanding (of perceptions)” (p. 8), it seems without the capacity of reason, rational beings cannot have comprehension.
#+end_quote

Yes.

#+begin_quote
If “reason is aiming at the sort of systematic understanding of things that allows us to make sense of them” (p. 9), then is “reason” the ultimate end? 
#+end_quote

I don't think so. The end, on a view like Schafer's is comprehension/understanding
(i.e. a systematic grasp of how all the individual parts of one's knowledge fit
together). Reason determines the ends of the other faculties, but its own end is
comprehension (again on a "cognitivist" view like that of Schafer). 

#+begin_quote
it seems without the faculty of desire, rational beings will not have the faculty of reason. Then should we understand the faculty of desire as a more fundamental capacity?
#+end_quote

I take it that Schafer is arguing that a rational being needs a faculty of desire.
But that the faculty of desire is necessary does not mean that it is fundamental.
Comapare: the existence of Scorates entails the existence of sigleton Soctrates (i.e.
the set consisting of Socrates as the only element). But Socrates is the more
fundamental being. 

**** Trevor
#+begin_quote
When Kant talks about the a priori does he basically mean things you actively contribute to your experience instead of passively receive?
#+end_quote

Kant thinks that all of our a priori knowledge is based on what we as subjects
contribute to experience. But this is compatible with thinking that we make a
*receptive* contribution, in virtue of our "forms of sensibility"---viz. space and
time.
...
**** Eunhong
#+begin_quote
The first question is whether Gettier Problem can be applied to Kant’s self-knowledge (I’m not sure self-knowledge is the same as the rational belief for Kant). The second question is whether the belief is self-conscious or not as what Land says. As Land says in his article (2018), Kant does not distinguish between belief and judgment. 
#+end_quote

The kind of faculty analysis Land proposes seems to assume that we *already* have the
relevant self-knowledge, and that all we do is make it explicit. Part of the argument
for this seems to be that the possession of implicit knowledge concerning the
working of our rational capacities is necessary for explaining our activity of
responding to reasons. Since we already have this knowledge implicitly it can't be
"Gettiered". 

It's an interesting question as to whether Kant distinguishes between "belief" (in
the sense used in modern Anglophone philosophy to designate the most basic or general kind of
doxastic state) and judgment. Kant has a conception of assent (/Fürwahrhalten/) that is
the closes to our notion of a propositional attitude. Judgment is not assent, and
Land unfortunately sidesteps the question of how the two are related (note 20). Does
Kant distinguish between judgment as event and belief as state? This is also somewhat
difficult to assess, since Kant holds that time is ideal. So there is a sense in
which the judgment/belief distinction cannot be made fundamentally in terms of time
or tense. It seems rather more plausible to me that Kant thinks of "beliefs" (or the
closest analogue that those might have in his system---viz. forms of assent) as
capacities to judge, and judgments as actualizations of those capacities.  



**** John
#+begin_quote
in what way is the concept of capacity differentiated from the concept of faculty? Does Kant distinguish this? Does Schafer use them according to Kant’s usage?
#+end_quote

Here's Karl's note 12 on this: "Kant uses a variety of terms to refer to mental
capacities or faculties – including Vermögen, Fähigkeit, and Kraft. There is
considerable debate about the exact relationship between these, but in what follows I
will generally use “capacity” and “faculty” interchangeably to refer to what Kant
refers to by “Vermögen”" (p. 190). Using "faculty" and "capacity" strikes me as fair. 

#+begin_quote
In page 183, Schafer repeats his contention in p. 180 that practical reason takes a cognitive-then-metaphysical structure. My impression is that the order of cognition and order of metaphysical explanation stand on a relation of conjunction, not with respect to chronology. But Schafer seems to also imply that there is some priority awarded to the order of cognition. Why is this? If priority is necessary, what is its bearing (read: what for?, why is it relevant?) in this particular Kantian project?
#+end_quote

Karl's claim is that the fact of reason "displays the priority of our basic rational
faculties in both the order of cognition and the order of metaphysical explanation."
What he is saying is that capacities are both metaphysically fundamental, and
epistemically fundamental. This isn't about "chronology" -- i.e. the notion of
"prior" here isn't temporal but explanatory. Epistemic priority is relevant because
Kant's project aims at explaining how we have various kinds of knowledge or
comprehension, and Karl's position is that this is ultimately explained in terms of
capacities. 

#+begin_quote
I guess I am a bit surprised to learn that sensibility also follows an internal principle too. Does this mean the receptive faculty of the mind, which is sensibility, follows some principle from what it receives, therefore externally? If it is internal, does this mean even sensibility follows some rule in receiving intuitions from the world? 
#+end_quote

Every capacity, as such, is going to have an "internal principle" (I would just say a
"constitutive causal law") that distinguishes its activity from other capacities.
Sensibility is no different. For Kant, sensibility is a receptive faculty, so it's
causal law appeals to something distinct from the sensible faculty in its activity,
and the most basic forms such laws take will concern space and time. 

**** Trevor
#+begin_quote
First question, on page 178 Schafer introduces and quickly dismisses “Agency-First Constitutivism” with three objections. He doesn’t spell these out and I was curious about them. Could you possibly give us a quick rundown of what is supposed to be wrong here? I particularly think the problem he mentions regarding agency being more focused on practical rather than theoretical reason to be suspicious. If agency helps us with practical reasoning, why not all reasoning? He admits that these two views “converge” on the next page, but then why even bring up the objections?
#+end_quote

The discussion isn't meant to be definitive as Schafer has another article devoted
to it. The point about practical vs. epistemic is merely that "Agency-first"
constitutivism tends to focus on /practical/ reasoning rather than /epistemic/ reasoning.
Schafer's aim is to provide a unified account, so he thinks that a constitutivism
that focuses merely on one strand of reason is going to be unsatisfactory. I take it
that he doesn't think appeals to "agency", understood as voluntary action, can help
us understand epistemic activity. As he puts it in the other 2018 essay "I think that
the proper starting point of the constitutivist project is best described—not as
conception of agency per se—but rather as a general conception of rationality, of
which rational agency is one form." (p. 71)

#+begin_quote
Second question, given what is said about Kant’s view of our capacity of cognition, what would Kant make of the phenomenon of blind-sight? Is anything being represented to the agent who experiences blind-sight or not? It seems like there is some sort of representation, but doesn’t seem to be one Kant recognizes.
#+end_quote

Clearly something is being represented by the blind-sighter. The assumption of the
phenomenon is that they represent a fact without any phenomenal conscious access to
the fact. If this is accurate to how blindsight works, the question is how it would
be accommodated in Kant's framework. Kant allows that many (most?) of our
representations are unconscious. He says "The field of sensuous intuitions and
sensations of which we are not conscious, even though we can undoubtedly conclude
that we have them; that is, obscure representations in the human being (and thus also
in animals), is immense" (7:135). Kant does not, however, allow that there can
unconscious cognition (in his technical sense in which cognition requires determinacy
of its object). But this seems to fit with contemporary conception of the status of
blindsight representation.


**** Janelle
#+begin_quote
Is the way that Kant is using legislation ... the same way as legislation is normally understood? 
#+end_quote

Good question -- the way in which Kant uses the idea of "self-legislation" has been
perplexing to many. I read "legislation" as, at minimum, "providing the law or rule".
Both understanding and reason do this.

#+begin_quote
the understanding is the capacity that forms concepts, and because of this, all concepts are governed by understanding which is housed in reason?
#+end_quote

Understanding forms concepts and judgments. It's activity constitutes nature, as the
sum of all appearances, in the sense of providing principles (e.g. causation) that
organize all appearances in time and space. It is "housed" in reason only in the
sense that its activity is directed towards giving material (judgments) to reason for
the purpose of comprehension.   

#+begin_quote
I understand Kant rejects that we cannot know objects in and of themselves, but how are the faculties of the human mind (particularly in other humans and not one’s own) not considered objects?
#+end_quote

Usually what Kant means by "object" is "empirical object". The activity of our
faculties is not something that is an empirical object of knowledge. Karl's strategy
(like Land's) is to argue that the activity of these faculties is "self-conscious" in
the sense that its activity is in principle available to the subject whose activity
it is. The passage you point to on 185 indicates that the ends of the rational
faculties are consciously accessible in the faculty's own activity.  

Concerning the "surrogate" passage -- I don't see that this undermines a "capacities
first" approach. And I don't see that it undermines the sense of "priority" at issue
since compassion doens't provide a "reason" to act morally except in so far as one
has developed reason. Instead it just helps "track" what morality requires without
representing that as such. Another way to put this is that compassion encourages
acting in accordance with what the moral law requires though it doesn't allow us to
act /from/ or /in light of/ what the law requires. 

#+begin_quote
Are capacities and faculties interchangeable? This question is answered in the Kern reading, but I take it that the capacity tells us the actualization conditions of a faculty?
#+end_quote

See my answer to John on this. 

**** Chen

#+begin_quote
[Regarding Kern,] I do not understand how “either perfect or imperfect agreement with the concept of
knowledge” solves the problem of “luck”.
#+end_quote

As far as I understand Kern's argument, the claim seems to be that the capacity for
knowledge is individuated in terms of its manifestation, which must itself be
understood in terms of the end of non-accidentally true belief. So the claim is that
*necessarily*, if the capacity is being exercised in good conditions, its exercise
results in non-accidentally true belief. So on this view it is impossible to excise
the capacity properly (i.e. skillfully and in good conditions) and have it be the
case that one fails to know. This is in contrast with Sosa's view, according to which
it is only /highly likely/ that the exercise of the capacity in good conditions results
in knowledge.

#+begin_quote
). It is explained by Kern that there are differences between self-conscious teleological cause and non-self-conscious teleological cause. Does Kant solve this question by claiming that self-conscious teleological cause requires no creator?
#+end_quote

I think Kern goes beyond what Kant explicitly says here. But I take her move to be in
saying that we have to individuate the capacity for knowledge in a way that requires
that its exercise involve the consciousness (or representation -- this part is
unclear) of the end for which the capacity is exercised -- i.e. non-accidentally true
judgment. As she puts it, "A capacity for knowledge is one whose exercises fall under
the concept of this capacity from the perspective of the subject whose capacity it
is. It is a capacity whose exercises consist in an employment of the concept of that
capacity by the subject who possesses it" (p. 252).

#+begin_quote
Kern also introduces the term “self-constituting capacity” that “a rational capacity for experiential knowledge is a capacity that constitutes itself by employing concepts of objects that make objects of experiential knowledge possible in the first place and, hence, that constitutes itself through a priori knowledge of itself as a capacity for experiential knowledge” (p. 256). But I am still confused. I have no idea of the “a priori knowledge”. Is it an inborn capacity? If we explain the capacity for experiential knowledge by “a priori knowledge”, how do we explain the latter? 
#+end_quote

I find this part of the view pretty obscure. In the next chapter she explicitly
rejects the idea that it is an "inborn" capacity. She follows Aristotle in arguing
that "rational capacities are not “innate” but “come by practice” (p. 258). She
argues that this acquisition through practice is one of learning. But the details of
how she understands this "learning" go beyond what I can discuss here. 
...
**** John
#+begin_quote
I cannot seem to get what Schafer means by “continual expansion of the scope and
depth of our theoretical cognition from comparative principles” (p. 200). ... In what
way can I frame Belief (Glaube) to be expanding in scope and depth?
#+end_quote

#+begin_quote
In page 209, Schafer contends,

Kant’s discussion on the relationship between God’s existence and the demands of
morality is meant to build up upon his prior discussion of the (admittedly very thin)
sense in which the theoretical reason commits us to the idea that “God” exists.

But if belief in God’s existence is essentially doctrinal belief, and it is
essentially a Glaube, one that is subjectively sufficient but not objectively
sufficient and therefore pursued for pragmatic ends, might this reading (quoted
above) be a little difficult to defend. It seems to me belief in God still falls well
within the parameters of practical reason. This makes it easier to see the continuity
between belief in God and the demands of morality – for both of them are ends to
which the practical reason is most apt to pursue. 
#+end_quote

I'm not sure what the question is here.

#+begin_quote
It seems plain that logical maxims, because of its theoretic nature, allows us to
posit the unconditioned. But it’s not clear to me if hypothetical imperatives can do
the same (or if it would even make sense to say that it can). If we suppose that the
latter cannot give us access to the unconditioned, then our ‘access’ is one way –
from logical maxims to hypothetical imperatives. So only with its link with logical
maxim can hypothetical imperative be related to the unconditioned. The unity then
becomes characteristically an asymmetrical relation to the unconditioned. But I am
not sure if this is a plausible interpretation though.
#+end_quote
...
**** Eunhong
#+begin_quote
According to Schafer, Willaschek uses the meaning of “unconditioned” in a very weak
way: only regulatively. Schafer thinks that we have to understand the principle
stronger than Willaschek’s interpretation. However, I could not fully understand why
we have to understand the principle in a stronger way. The evidence that Schafer
suggests is as follows:
 
“…in introducing the “supreme principle”, Kant explicitly claims that the “logical
maxim” can only become a “principle of pure reason” – i.e. that it can only assume
the role of a principle governing reason’s theoretical use-if “we assume” that the
whole series of conditions, and so the unconditioned, is “given (i.e. contained in
the object and its connection. Thus, the must straightforward reading of this passage
is that the acceptance of the “logical maxim” requires the acceptance of the
existence of the unconditioned.”
 
Still, it seems to me that Kant says the “logical maxim” can have the possibility
that can become a principle of pure reason. Even if the logical maxim can only assume
the role of a principle governing reason’s theoretical use, I am not sure why it
guarantees the existence of the unconditioned. We cannot think of the unconditioned
directly.[5] The only thing we can think of is the assumed existence of the
unconditioned, not the existence of the unconditioned. Therefore, I would like to
know a more detailed explanation that Schafer’s objection to Willaschek’s views of
principles.
#+end_quote
**** Chen
#+begin_quote
My question here is quite basic. Schafer develops the discussion around the concepts
“conditioned” and “unconditioned”, but my understanding of them is very vague and
uncertain, if I ever have any understanding. What on earth do “conditioned” and
“unconditioned” mean? Why is the distinction important for Kant/Schafer? What are
“conditions”? What is the relationship between “conditions” and the limits on our
capacities for theoretical cognition and practical cognition?
#+end_quote
**** Janelle
#+begin_quote
Is, according to the Schaffer [sic.] view, the human being as such enough to get the
practical end, or does it require the human being to cultivate the relevant faculties
(and subsequently actualizing the capacities of those faculties).
#+end_quote
**** Trevor
#+begin_quote
If we can characterize reasons activity by referencing its “proper functioning”,
doesn’t the ideality of space and time seem a little weird? If I am engaging in
reasoning regarding space or time, those representations I have of space or time
won’t actually pick out anything in the real world, so is it really functioning
properly? Is the proper function of reason to accomplish (i)-(iii) (as mentioned on
page 190) with regards to representations of things that don’t exist except in our
minds?
#+end_quote

#+begin_quote
I remember being told that the reason’s search for the unconditioned is basically a
search for an ultimate cause. Given my simplistic understanding, I am not sure how to
interpret Schafer’s view that we should properly interpret Kant as saying we must
accept the existence of the unconditioned. Does that mean we must accept that there
are ultimate causes generally or that there is some specific ultimate cause?
Schafer’s language makes it sound like the latter but then I wonder why this is even
a controversial interpretation of Kant when Kant specifically says that we must posit
the existence of God, who would presumably fulfill this role as ultimate cause.
#+end_quote
* Website
** Pages
:PROPERTIES:
...
- [[/materials/handouts/11-kant-transformation.pdf][Handout]] for week 11
...
*** DONE Week 12 - Teleology
SCHEDULED: <2020-11-03 Tue>
:PROPERTIES:
:EXPORT_HUGO_TAGS: capacities rationality teleology transformation  
...
- Schafer, "[[/materials/readings/schafer-transformative-rationality.pdf][A System of Rational Faculties: Additive or Transformative?]]"
- Mudd, "[[/materials/readings/mudd-systematicity.pdf][The Demand for Systematicity and the Authority of Theoretical Reason in Kant]]"
- Mudd, "[[/materials/readings/mudd-priority.pdf][Rethinking the Priority of Practical Reason in Kant]]"
- Mudd, "Autonomy as the end of theoretical reason in Kant" (see listserv for link)
# - Mudd, 
# - Kern, "The Teleology of Rational Capacities"

*** DONE Week 13 - Capacities, Teleology, & Knowledge
SCHEDULED: <2020-11-10 Tue>
:PROPERTIES:
:EXPORT_HUGO_TAGS: capacities rationality teleology knowledge
...
- Kern, "[[/materials/readings/kern-knowledge.pdf][The Teleology of Rational Capacities]]"
- Schafer, "[[/materials/readings/schafer-capacities.pdf][Kant: constitutivism as capacities-first philosophy]]"
- (Optional) Land, "[[/materials/readings/land-faculties.pdf][Epistemic agency and the self-knowledge of reason]]"

*** DONE Week 14 - The Unity of Reason
SCHEDULED: <2020-11-17 Tue>
:PROPERTIES:
:EXPORT_HUGO_TAGS: autonomy capacities comprehension knowledge principles PSR rationality teleology 
